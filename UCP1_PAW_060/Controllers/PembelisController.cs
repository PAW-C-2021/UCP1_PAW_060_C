...
namespace UCP1_PAW_060.Controllers
{
    public class PembelisController : Controller
    {
        ...
        public PembelisController(PenjualanBajuContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPembeli,Password,Alamat,NoTelepon")] Pembeli pembeli)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPembeli,Password,Alamat,NoTelepon")] Pembeli pembeli)
        {
