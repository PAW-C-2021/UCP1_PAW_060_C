...
namespace UCP1_PAW_060.Controllers
{
    public class TransaksisController : Controller
    {
        ...
        public TransaksisController(PenjualanBajuContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdTransaksi,TanggalTransaksi,KodeBaju,HargaBaju,JumlahBaju,TotalBaju,IdPenjual,IdPembeli")] Transaksi transaksi)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdTransaksi,TanggalTransaksi,KodeBaju,HargaBaju,JumlahBaju,TotalBaju,IdPenjual,IdPembeli")] Transaksi transaksi)
        {
